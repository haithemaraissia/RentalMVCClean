...
using RentalMobile.Helpers.Photo.PrivateProfile.Provider;
...
namespace RentalMobile.Controllers.PrivateProfile.Provider
{
    ...
    public class ProviderController : BaseController
    {
        ...
        {
            return View(UserHelper.ProviderPrivateProfileHelper.GetAllProviderZones()
                .ToList()
                .ToPagedList(page, 10));
        }
        ...
        public ActionResult AddTeamMember(int page = 1)
        {
            ...
            IEnumerable<Model.Models.Specialist> excludedSpecialistList =
