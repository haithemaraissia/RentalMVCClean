...
namespace TestProject.UnitTest.Application.Controllers.InProgress.Process.Tenant.Application
{
    [TestClass]
    public class TenantRentalApplicationControllerTest
    {
        ...
        public void Index()
        {
            ...
            //var data = viewResult.ViewData.Model as IList<TenantRentalApplicationController>;
        ...
        public void Details()
        {
            ...
            //var viewResult = actual as ViewResult;
            //if (viewResult == null) return;
            //var data = viewResult.ViewData.Model as TenantRentalApplicationController;
