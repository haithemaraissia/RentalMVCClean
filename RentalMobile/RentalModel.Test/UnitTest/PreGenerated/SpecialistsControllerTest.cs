...
namespace TestProject.UnitTest.Controller
{
    ...
    {
        //public FakeSpecialistsControllers FakeSpecialistsControllers;
        //public SpecialistsControllerController Controller;

        [TestInitialize]
        public void Initialize()
        {
            // Arrange
            //var fakeSpecialistsControllers = new FakeSpecialistsControllers();
            //var SpecialistsControllerRepo = new FakeSpecialistsControllerRepository(fakeSpecialistsControllers.MySpecialistsControllers);
            //var uow = new SpecialistsControllerofWork { SpecialistsControllerRepository = SpecialistsControllerRepo };
            //Controller = new SpecialistsControllerController(uow);
        }
        ...
        public void CleanUp()
        {
            //FakeSpecialistsControllers = null;
            //Controller.Dispose();
        }
    }
}
