...
namespace TestProject.UnitTest.Controller
{
    ...
    {
        //public FakeContactControllers FakeContactControllers;
        //public ContactControllerController Controller;

        [TestInitialize]
        public void Initialize()
        {
            // Arrange
            //var fakeContactControllers = new FakeContactControllers();
            //var ContactControllerRepo = new FakeContactControllerRepository(fakeContactControllers.MyContactControllers);
            //var uow = new ContactControllerofWork { ContactControllerRepository = ContactControllerRepo };
            //Controller = new ContactControllerController(uow);
        }
