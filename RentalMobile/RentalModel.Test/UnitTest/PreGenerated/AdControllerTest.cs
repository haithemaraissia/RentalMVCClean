...
namespace TestProject.UnitTest.Controller
{
    ...
    {
        //public FakeAdControllers FakeAdControllers;
        //public AdControllerController Controller;

        [TestInitialize]
        public void Initialize()
        {
            // Arrange
            //var fakeAdControllers = new FakeAdControllers();
            //var AdControllerRepo = new FakeAdControllerRepository(fakeAdControllers.MyAdControllers);
            //var uow = new AdControllerofWork { AdControllerRepository = AdControllerRepo };
            //Controller = new AdControllerController(uow);
        }
        ...
        public void Index()
        {
            ...
            //var data = viewResult.ViewData.Model as IList<AdController>;
        ...
        public void Details()
        {
            ...
            //var viewResult = actual as ViewResult;
            //if (viewResult == null) return;
            //var data = viewResult.ViewData.Model as AdController;
