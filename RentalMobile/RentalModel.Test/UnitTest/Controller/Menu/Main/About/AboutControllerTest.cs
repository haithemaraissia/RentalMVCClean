...
namespace TestProject.UnitTest.Controller.Simple
{
    ...
    public class AboutControllerTest
    {
        ...
        {
            // Arrange
            //var fakeAbouts = new FakeAbouts();
            //var aboutRepo = new FakeAboutRepository(fakeAbouts.MyAbouts);
            //var uow = new UnitofWork { AboutRepository = aboutRepo };
            //Controller = new AboutController(uow);
        }
