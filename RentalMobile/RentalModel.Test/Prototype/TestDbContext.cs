...
namespace TestProject.Prototype
{
    ...
    {
        private readonly DbSets _dbSets;
        ...
        public TestDbContext(bool enableLazyLoading, bool enableProxyCreation)
            : base("Name=TestDbContext")
        {
            _dbSets = new DbSets();
        ...
        {
            context.DbSets.Units.AddRange(new FakeUnits().MyUnits);
            context.SaveChanges();
        }
