...
namespace TestProject.Tools.UnitTest.Controller
{
    ...
    {
        //public AdvancedSearchController Controller;

        [TestInitialize]
        public void Initialize()
        {
            // Arrange
            //var fakeAdvancedSearchs = new FakeAdvancedSearchs();
            //var advancedSearchRepo = new FakeAdvancedSearchRepository(fakeAdvancedSearchs.MyAdvancedSearchs);
            //var uow = new UnitofWork { AdvancedSearchRepository = advancedSearchRepo };
            //Controller = new AdvancedSearchController(uow);
        }
