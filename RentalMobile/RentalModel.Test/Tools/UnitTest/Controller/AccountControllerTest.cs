...
namespace TestProject.Tools.UnitTest.Controller
{
    ...
    public class AccountControllerTest
    {
        ...
        {
            // Arrange
            //var fakeAccounts = new FakeAccounts();
            //var accountRepo = new FakeAccountRepository(fakeAccounts.MyAccounts);
            //var uow = new UnitofWork { AccountRepository = accountRepo };
            //Controller = new AccountController(uow);
        }
