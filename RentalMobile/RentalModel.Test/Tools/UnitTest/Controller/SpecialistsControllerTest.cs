...
namespace TestProject.Tools.UnitTest.Controller
{
    ...
    public class SpecialistsControllerTest
    {
        ...
        {
            // Arrange
            //var fakeSpecialits = new FakeSpecialits();
            //var specialitRepo = new FakeSpecialitRepository(fakeSpecialits.MySpecialits);
            //var uow = new UnitofWork { SpecialitRepository = specialitRepo };
