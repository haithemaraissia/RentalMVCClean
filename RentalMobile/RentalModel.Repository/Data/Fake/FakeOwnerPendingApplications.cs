...
{
    public class FakeOwnerPendingApplications
    { 
       public List<OwnerPendingApplication> MyOwnerPendingApplications;

       public FakeOwnerPendingApplications()
        {
            InitializeOwnerPendingApplicationList();
        }

       public void InitializeOwnerPendingApplicationList()
        {
            MyOwnerPendingApplications = new List<OwnerPendingApplication> {
                FirstOwnerPendingApplication(), 
                SecondOwnerPendingApplication(),
                ThirdOwnerPendingApplication()
            };
        }

       public OwnerPendingApplication FirstOwnerPendingApplication()
        {

            var firstOwnerPendingApplication = new OwnerPendingApplication {
...
,
            ...
            return firstOwnerPendingApplication;
        }

       public OwnerPendingApplication SecondOwnerPendingApplication()
        {

            var secondOwnerPendingApplication = new OwnerPendingApplication {
...
,
            ...
            return secondOwnerPendingApplication;
        }

       public OwnerPendingApplication ThirdOwnerPendingApplication()
        {

            var thirdOwnerPendingApplication = new OwnerPendingApplication {
...
,
            ...
            return thirdOwnerPendingApplication;
        }

        ~FakeOwnerPendingApplications()
        {
            MyOwnerPendingApplications = null;
        }
    }
}
